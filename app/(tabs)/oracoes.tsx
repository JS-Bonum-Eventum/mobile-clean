...
function PrayerIcon({
  ...
  return (
    <Ionicons
      name={prayer.iconName as keyof typeof Ionicons.glyphMap}
      size={size}
      color={color}
    />
  );
...
const PRAYERS: Prayer[] = [
  ...
  },
  {
    ...
    iconSet: "ionicons",
    accentColor: "#E74C3C",
    text: `COMO REZAR A COROA DA DIVINA MISERICÓRDIA\n\nInício: 1 Pai Nosso, 1 Ave Maria, Creio em Deus Pai.\n\nNas contas do Pai Nosso (5 vezes):\n"Pai Eterno, ofereço-vos o Corpo, o Sangue, a Alma e a Divindade de vosso Amabilíssimo Filho, Nosso Senhor Jesus Cristo, em propiciação por nossos pecados e pelos do mundo inteiro."\n\nNas contas da Ave Maria (10 vezes por mistério):\n"Pela Sua dolorosa Paixão, tende misericórdia de nós e do mundo inteiro."\n\nFinalização (3 vezes):\n"Santo Deus, Santo Forte, Santo Imortal, tende piedade de nós e do mundo inteiro."\n\nEsta coroa foi revelada a Santa Faustina Kowalska\ne aprovada pela Igreja Católica.\nReze-a especialmente às 15h (Hora da Misericórdia).`,
  },
];
...
function PrayerCard({ prayer, onPress }: { prayer: Prayer; onPress: () => void }) {
  ...
  return (
    <Animated.View style={animStyle}>
      ...
      >
        <View
          style={[styles.prayerIcon, { backgroundColor: prayer.accentColor + "20" }]}
        >
    ...
    >
      <View style={[styles.modalRoot, { paddingTop: topPad }]}>
        ...
        >
          <View
            style={[
              styles.prayerIconLarge,
              { backgroundColor: prayer.accentColor + "20" },
            ]}
          >
          ...
          <View
            style={[styles.divider, { backgroundColor: prayer.accentColor }]}
          />
...
export default function OracoesScreen() {
  ...
  const tercos = [PRAYERS[11], PRAYERS[12]];
